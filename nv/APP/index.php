            ...
            $.ajax({
                    ...
                    success: function(datos){
                        if (datos=="EXECUTING"){
                            ...
                            Swal.fire({
                                icon:"success",
                                title:"Proceso ejecutando, espere por favor a que el proceso termine",
                                text: "...",
                                didOpen: ()=>{
                                    Swal.showLoading();
                                }/**,
                            ...
                            validateStatus();
                        }else if (datos=="NOEXECUTING"){
                            Swal.fire({
                                icon:"info",
                                title:"El proceso esta ocupado en el momento",
                                text: "Intente nuevamente más tarde"
                            });
                        }else{
                            Swal.fire({
                                icon:"warning",
                                title:"No se pudo ejecutar el proceso",
                                text: datos
                            });
                        }
                    },
        ...
        function ChargeData(e,text) {
            ...
            function initialize(e){
                try{
                    Swal.fire({
                        ...
                        text:"Realizando validaciones previas",
                        didOpen: ()=>{
                            Swal.showLoading();
                        },
                        allowOutsideClick: false,
                    ...
                    let tdb = document.getElementById("bds");
                    if (tdb ? tdb.value != null && tdb.value != "" : false){
                        $.ajax({
                            type: "POST",
                            url: url_serv+"/Initialize.php",
                            data:{
                                "bds" : tdb.value
                            },            
                            success: (result)=>{
                                console.log(result);
                                if (result==null ? true : result["code"] == 500){
                                    Swal.fire({
                                        icon:"warning",
                                        title: "Proceso de validación con errores!",
                                        text: result==null ? "No se pudo validar la respuesta de las validaciones previas" : result["message"]
                                    });
                                }else{
                                    if (result["code"]==200){
                                        Toast.fire({
                                            icon:"success",
                                            title:"Base de datos inicializada satisfactoriamente",
                                            text: "Procedimientos y funciones inicializados con normalidad"
                                        });
                                    }
                                    Swal.close();
                                }
                            ...
                            error: (err)=>{
                                ...
                                Swal.fire({
                                    icon:"warning",
                                    title: "Ocurrió un error durante la validación de la base!",
                                    text: "Verifique la consola para obtener mas detalles"
                                });
                            }, 
                            dataType: 'json'
                        });
                        ...
                        Swal.fire({
                            icon:"warning",
                            text:"No se ha escogido una base de datos válida"
                        });
                    }
                }catch(e){
                    Swal.fire({
                        icon:"warning",
                        text:"Se produjo una excepción al realizar el proceso"
                    });
                }
            }
            ...
            function validateStatus(){
                try{
                    ...
                    $.ajax({
                        type: "POST",
                        url: url_serv+"/VerificarEstado.php",
                        data:{
                            "bds" : tdb.value
                        },            
                        success: (status)=>{
                            if (status == "1"){
                                ...
                                Swal.fire({
                                    icon:"info",
                                    title:"Proceso terminado, verifique la descripción del resultado"
                                });
                            }else{
                                Swal.fire({
                                    icon:"info",
                        ...
                        error: (err)=>{
                            console.log("validateStatus :: ",err);
                            Swal.fire({
                                icon:"error",
                                title:"Se produjo un error a nivel de conexión, verifique el estado en base de datos"
                            });
                        }, 
                        dataType: 'text'
                    });
                    ...
                    console.log("validateStatus :: ",e);
                    Swal.fire({
                        icon:"error",
                        title:"Se produjo una excepción durante la validación ciclica, verifique el estado en base de datos"
                    });
                }
            }
        </script>
                        ...
                        <div class="BaseDatos col-6 justify-content-center">
                            <h4 class="text-center">Base de Datos</h4>
                                <div class="col-8 m-auto">
                                    <select class="form-select text-center " name="bds" id="bds" onchange="initialize(event)">    
